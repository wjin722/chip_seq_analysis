...
# in/out parameters
dir_in <- 'input'
dir_out<- 'output_bivalent'

file_name <- 'RTKI_K27me3+K4me3'

# readin files
gic_gain <- as.data.frame(read.table(file.path(dir_in, "RTKI_K27me3_K4_K27me3_RTKI_gic_gain.bed_K4me3_RTKI_gic_gain.bed"),header = FALSE, sep="\t",stringsAsFactors=FALSE, quote=""))
...
loss_gain <- as.data.frame(read.table(file.path(dir_in, "ALL_K27me3_K4_K27me3_ALL_v2_gic_loss.bed_K4me3_ALL_gic_loss.bed"),header = FALSE, sep="\t",stringsAsFactors=FALSE, quote=""))
