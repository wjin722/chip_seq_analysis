...
gain.peaksAnno=annotatePeakInBatch(granges_gain, AnnotationData=TSS.human.GRCh38)

granges_loss <- GRanges(loss_gain)
loss.peaksAnno=annotatePeakInBatch(granges_loss, AnnotationData=TSS.human.GRCh38)
